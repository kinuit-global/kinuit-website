...
export default function SidebarFooter({ isCollapsed }: SidebarFooterProps) {
  return (
    <div className={cn(
      "p-6 border-t border-slate-100 text-center transition-all duration-300 shrink-0 overflow-hidden",
      ...
      <p className="text-slate-300 text-[8px] font-black uppercase tracking-[0.2em] whitespace-nowrap">
