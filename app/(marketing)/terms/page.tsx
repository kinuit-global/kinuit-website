...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms & Conditions" lastUpdated="March 2026">
      <section>
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">1. Acceptance of Terms</h2>
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">2. Our Services</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <ul className="list-disc pl-6 text-white/70 space-y-3 mb-6">
          <li><strong className="text-white font-bold">Build:</strong> Custom websites, mobile apps, AI products, Web3 development, and e-commerce solutions.</li>
          <li><strong className="text-white font-bold">Design:</strong> Brand identity, UX/UI design, motion graphics, and creative assets.</li>
          <li><strong className="text-white font-bold">Grow:</strong> SEO, paid advertising, social media marketing, and community management.</li>
          <li><strong className="text-white font-bold">Plan:</strong> Growth strategy, go-to-market planning, and tokenomics.</li>
          <li><strong className="text-white font-bold">Manage:</strong> CRM integration (HubSpot/Salesforce) and brand operations.</li>
        </ul>

        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">3. Intellectual Property</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">4. Client Responsibilities</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">5. Payment Terms</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">6. Limitation of Liability</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">7. Governing Law</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-bold mb-6 text-white tracking-tight">8. Contact Us</h2>
        <p className="text-white/70 text-lg leading-relaxed mb-6">
          For any questions regarding these Terms & Conditions, please contact us at <strong className="text-white font-bold">hello@kinuit.com</strong>.
        </p>
      </section>
    </LegalLayout>
  );
