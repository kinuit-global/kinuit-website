...
export default function ServicesHero() {
  return (
    <section className="bg-gradient-to-b from-[#050D1A] to-k-bg pt-40 pb-20 md:pt-48 md:pb-32 border-b border-white/5">
      <Container>
        <div className="max-w-4xl flex flex-col items-start text-left">
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.2 }} className="text-[#0059FF] font-black tracking-widest text-sm mb-6 uppercase">WHAT WE OFFER</motion.div>
          ...
          <motion.p {...fadeUp} transition={{ delay: 0.4 }} className="text-white/90 text-sm sm:text-base md:text-lg font-thin leading-[1.8] max-w-3xl mb-16">
