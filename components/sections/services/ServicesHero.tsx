...
export default function ServicesHero() {
  return (
    <section className="bg-k-bg pt-40 pb-20 md:pt-48 md:pb-32 border-b border-k-border">
      <Container>
        <div className="max-w-4xl flex flex-col items-start text-left">
          ...
          <motion.h1 {...fadeUp} transition={{ delay: 0.3 }} className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 text-k-text leading-tight tracking-tight">
            ...
            <span className="text-k-primary">All in one place.</span>
          </motion.h1>
          <motion.p {...fadeUp} transition={{ delay: 0.4 }} className="text-k-text-muted text-lg md:text-xl font-light leading-relaxed max-w-3xl mb-16">
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.5, duration: 0.8 }} className="w-full max-w-5xl aspect-video md:aspect-21/9 rounded-3xl overflow-hidden shadow-2xl border border-k-border relative">
