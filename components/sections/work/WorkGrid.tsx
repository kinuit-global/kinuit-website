...
export default function WorkGrid() {
  return (
    <Section className="bg-k-bg border-t border-white/5 py-20 md:py-32">
      <Container>
          ...
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-white mb-6 group-hover:text-[#0059FF] transition-colors duration-300">
                  {project.title}
                </h3>
                
                <div className="text-white/70 space-y-3 mb-8 text-sm md:text-base leading-relaxed">
                  <p><strong className="text-white">What they needed:</strong> {project.challenge}</p>
                  <p><strong className="text-white">What we did:</strong> {project.solution}</p>
